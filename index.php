...
?>
<body>
    <div class="jumbotron-fluid d-flex justify-content-between" id="jumbotron">
        <div class="container-fluid py-5">
            <h1 class="display-6 fw-bold">Led by practitioners &</h1>
            <h1 class="display-6 fw-bold">experts on the field</h1>
